...
export function AlignMenu() {
    ...
    const canAlign = !isCanvasLocked && selNodeCount + selActsCount + selCondsCount >= 2;
    ...
    return (
        <div style={ { display: "grid", gap: 4 } }>
            <button role="menuitem" disabled={ !canAlign } onClick={ () => canAlign && alignLeft() }
                title={ isCanvasLocked ? "Turn off Live to canvas to align items" : "Align to the left (edges)" } style={ menuItem }>
            ...
            <button role="menuitem" disabled={ !canAlign } onClick={ () => canAlign && alignCenterX() }
                title={ isCanvasLocked ? "Turn off Live to canvas to align items" : "Center horizontally (centers X)" } style={ menuItem }>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            <button role="menuitem" disabled={ !canAlign } onClick={ () => canAlign && alignRight() }
                title={ isCanvasLocked ? "Turn off Live to canvas to align items" : "Align to the right (edges)" } style={ menuItem }>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            <button role="menuitem" disabled={ !canAlign } onClick={ () => canAlign && alignTop() }
                title={ isCanvasLocked ? "Turn off Live to canvas to align items" : "Align to the top (edges)" } style={ menuItem }>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            <button role="menuitem" disabled={ !canAlign } onClick={ () => canAlign && alignMiddleY() }
                title={ isCanvasLocked ? "Turn off Live to canvas to align items" : "Center vertically (centers Y)" } style={ menuItem }>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            <button role="menuitem" disabled={ !canAlign } onClick={ () => canAlign && alignBottom() }
                title={ isCanvasLocked ? "Turn off Live to canvas to align items" : "Align to the bottom (edges)" } style={ menuItem }>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
