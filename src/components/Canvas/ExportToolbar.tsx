...
const EXPORT_MARGIN = 20; // debe coincidir con el overlay
...
export function ExportToolbar( { svgRef }: Props ) {
    ...
    const computeRect = React.useCallback( () => {
        ...
        if ( !B ) return null;
        const R = boundsToRectWithMargin( B, EXPORT_MARGIN );
    ...
    return (
        <div style={ { display: "flex", gap: 8 } }>
            <button
                ...
                title="Exportar SVG (segmento seleccionado)"
            ...
            <button
                ...
                title="Exportar JPG (segmento seleccionado)"
